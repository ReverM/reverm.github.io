...
ui.toolarea = {
	...
	setdisplay: function(idname) {
		...
		getEL("solver.status").textContent = isRunning ? ui.i18n("solver.status.running") : ui.i18n("solver.status");
