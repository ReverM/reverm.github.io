...
["_solve_problem","_enumerate_answers_problem","_malloc","_free","_memory","___indirect_function_table","onRuntimeInitialized"].forEach((prop) => {
...
function findWasmBinary() {
  if (Module['locateFile']) {
    var f = 'cspuz_solver_backend.wasm';
    if (!isDataURI(f)) {
      return locateFile(f);
    }
    return f;
...
var _solve_problem = Module['_solve_problem'] = createExportWrapper('solve_problem', 2);
var _enumerate_answers_problem = Module['_enumerate_answers_problem'] = createExportWrapper('enumerate_answers_problem', 3);
